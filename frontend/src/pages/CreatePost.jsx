...
//             </div>
//           </div>
//           <textarea  rows={5} cols={10} className='px-4 py-2 outline-none' placeholder='Enter post description'/>
...
const CreatePost = () => {
    ...
    const handleCreate = async (e) => {
      ...
      const post = {
          title,
          desc,
          username: user ? user.username : "", // Check if user exists before accessing its properties
          userId: user ? user._id : "", // Check if user exists before accessing its properties
          categories: cats
      };
